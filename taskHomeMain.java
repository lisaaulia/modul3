...
import Modul3.taskHomeParticipant;
import Modul3.taskHomeSerialization;
            ...
            switch(choice){
                ...
                case 2 : System.out.println("Menampilkan data : ");
                         ...
                         if(pilihItem == 0){
                             ...
                             datamu.get(pilihIndex).setNim(q);
                         }else if(pilihItem == 1){
                             System.out.println("Enter Nama : ");
                             String w = buf.readLine();
                             //b = buf.readLine();
                             datamu.get(pilihIndex).setNama(w);
                         }else if(pilihItem == 2){
                             System.out.println("Enter Asal : ");
                             String e = buf.readLine();
                             //c = buf.readLine();
                             datamu.get(pilihIndex).setAsal(e);
                         }else if(pilihItem == 3){
                             System.out.println("Enter Kelas : ");
                             String r = buf.readLine();
                             //d = buf.readLine();
                             datamu.get(pilihIndex).setKelas(r);
                         }
                         task.Serialize(datamu, fileName);
                    break;
